...
public class DaLiuRenActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daliuren);
    ...
    private void generatePaiPan() {
        ...
        paiPan.append("大六壬排盘结果:\n");
        paiPan.append("时间: ").append(java.time.LocalDateTime.now().toString()).append("\n");
        paiPan.append("日干: 甲\n");
        paiPan.append("时干: 乙\n");
        paiPan.append("四课: 甲子、乙丑、丙寅、丁卯\n");
        paiPan.append("三传: 初传、中传、末传\n");
        paiPan.append("贵人: 天乙贵人\n");
        paiPan.append("神煞: 青龙、朱雀、勾陈、螣蛇、白虎、玄武\n");
    ...
    private class DeepSeekAITask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                systemMsg.put("content", "你是一位精通大六壬的命理大师，请根据用户提供的排盘信息进行分析。");
        ...
        protected void onPostExecute(String result) {
            ...
            Toast.makeText(DaLiuRenActivity.this, "AI分析完成", Toast.LENGTH_SHORT).show();
        }
    }
}